# Declarations of terms tracked in the *test22* collection
...
You can [explore the tracked versions](https://github.com/Ndpnt/test22-versions) interactively or [download them as a dataset](https://github.com/Ndpnt/test22-versions/releases) in the `Ndpnt/test22-versions` repository.
